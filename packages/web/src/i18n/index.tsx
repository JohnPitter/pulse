...
const EN_TRANSLATIONS = {
  ...
  landing: {
    ...
    imageCard1Text: "Track status transitions and bottlenecks in real time.",
    imageCard2Title: "Execution evidence",
    imageCard2Text: "Visual proof of every run with logs and artifacts attached.",
    imageCard3Title: "Decision-ready dashboards",
    imageCard3Text: "Share snapshots that help teams act faster.",
...
const PT_BR_TRANSLATIONS: typeof EN_TRANSLATIONS = {
  ...
  landing: {
    ...
    imageCard1Text: "Acompanhe mudanças de status e gargalos em tempo real.",
    imageCard2Title: "Evidência de execução",
    imageCard2Text: "Prova visual de cada execução com logs e artefatos anexados.",
    imageCard3Title: "Dashboards para decisão",
    imageCard3Text: "Compartilhe snapshots que ajudam equipes a agir mais rápido.",
